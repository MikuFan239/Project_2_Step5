...
import MM from '../Pictures/2021MM.png';

const ConcertDetailMM2021 = () => {
         ...
         {/* Intro section */}
            <div className="intro">
               <div className="detailTitle">
                  ...
                  <h1 id="h1Right">{t('MM2021.subtitle')}</h1>
               </div>
            
               <div className="btnGroup">
                  <HashLink smooth to ='/ConcertDetailMM2021/#info'>
                     <button>{t('MM2019.intro-btn-1')}</button>
                  </HashLink>
                  <HashLink smooth to ='/ConcertDetailMM2021/#special'>
                  ...
                  <div className="continerCD inner">
                     ...
                     <div className="textGroup">
                        <div className="costumeText">
                           ...
                           <HashLink smooth to='/ConcertDetailMM2021/#costume'>{t('MM2019.intro-ct-hl')}<i class="arrowRight"/></HashLink>
                        </div>

                        <div className="themeText">
                           <p id='yearTheme'>{t('MM2019.intro-tt-p')}</p>
                           <h3 id='theme'>{t('MM2021.intro-tt-h3')}</h3>
                        </div>
                     </div>
                  </div>
            ...
            <div className="special" id="special">
               ...
               <div className="btnGroup">
                  <HashLink smooth to ='/ConcertDetailMM2021/#costume'>
                     <button>{t('MM2019.special-btn-1')}</button>
                  </HashLink>
                  <HashLink smooth to ='/ConcertDetailMM2021/#theme song'>
                     <button>{t('MM2019.special-btn-2')}</button>
                  </HashLink>
                  <HashLink smooth to ='/ConcertDetailMM2021/#after report'>
...
export default ConcertDetailMM2021;