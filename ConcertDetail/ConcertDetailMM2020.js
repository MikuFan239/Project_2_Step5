...
import MM from '../Pictures/2020MM_summer.png';

const ConcertDetailMM2020 = () => {
         ...
         {/* Intro section */}
            <div className="intro">
               <div className="detailTitle">
                  ...
                  <h1 id="h1Right">{t('MM2020.subtitle')}</h1>
               </div>
                  ...
                  <div className="continerCD inner">
                     ...
                     <div className="textGroup">
                        ...
                        <div className="themeText">
                           ...
                           <h3 id='theme'>{t('MM2020.intro-tt-h3')}</h3>
                        </div>
                     </div>
                  </div>
...
export default ConcertDetailMM2020;