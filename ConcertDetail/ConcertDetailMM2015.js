...
import MM from '../Pictures/2015MM.png';

const ConcertDetailMM2015 = () => {
         ...
         {/* Intro section */}
            <div className="intro">
               <div className="detailTitle">
                  ...
                  <h1 id="h1Right">{t('MM2015.subtitle')}</h1>
               </div>
            
               <div className="btnGroup">
                  <HashLink smooth to ='/ConcertDetailMM2015/#info'>
                     <button>{t('MM2019.intro-btn-1')}</button>
                  </HashLink>
                  <HashLink smooth to ='/ConcertDetailMM2015/#special'>
               ...
               <div className="continerCD">
                  <div className="continerCD inner">
                     ...
                     <div className="textGroup">
                        <div className="costumeText">
                           ...
                           <HashLink smooth to='/ConcertDetailMM2015/#costume'>{t('MM2019.intro-ct-hl')}<i class="arrowRight"/></HashLink>
                        </div>
                  ...
                  <img src={MM} alt="2019MMDetail" id='Detail2015MM'/>
               </div>
            </div>
            ...
            <div className="special" id="special">
               ...
               <div className="btnGroup">
                  <HashLink smooth to ='/ConcertDetailMM2015/#costume'>
                     <button>{t('MM2019.special-btn-1')}</button>
                  </HashLink>
                  <HashLink smooth to ='/ConcertDetailMM2015/#theme song'>
                     <button>{t('MM2019.special-btn-2')}</button>
                  </HashLink>
                  <HashLink smooth to ='/ConcertDetailMM2015/#after report'>
...
export default ConcertDetailMM2015;